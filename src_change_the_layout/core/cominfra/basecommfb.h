...
namespace forte {
  namespace com_infra {
    ...
    protected:
      ...
      /*!\brief Extract the id and the parameter and the ID. The format is ID[ID1] where the opening and closing brackets are actually a opening and a closing brackets. They can be escaped using the $ sign.
