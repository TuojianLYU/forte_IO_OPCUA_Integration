...
namespace forte {
  namespace com_infra {
    ...
    EComResponse CRawDataComLayer::sendData( void *paData, unsigned int){
      DEVLOG_DEBUG("----------------rawdatacomlayer CRawDataComLayer::sendData------------------\n");
    ...
    EComResponse CRawDataComLayer::recvData( const void *paData, unsigned int paSize){
      DEVLOG_DEBUG("----------------rawdatacomlayer CRawDataComLayer::recvData------------------\n");
    ...
    EComResponse CRawDataComLayer::openConnection(char *){
      DEVLOG_DEBUG("----------------rawdatacomlayer CRawDataComLayer::openConnection------------------\n");
